...
import { A as AstroError, E as ExpectedImage, L as LocalImageUsedWrongly, M as MissingImageDimension, U as UnsupportedImageFormat, I as IncompatibleDescriptorOptions, e as UnsupportedImageConversion, t as toStyleString, N as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, f as ExpectedImageOptions, g as ExpectedNotESMImage, h as InvalidImageService, i as createAstro, c as createComponent, j as ImageMissingAlt, m as maybeRenderHead, b as addAttribute, s as spreadAttributes, a as renderTemplate, k as ExperimentalFontsNotEnabled, l as FontFamilyNotFound, u as unescapeHTML, r as renderComponent, d as renderScript, n as renderSlot, o as renderHead } from './astro/server_D65K-Fvk.mjs';
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template([`<html lang="en" data-astro-cid-sckkx6r4> <head><!-- Google tag (gtag.js) --><script async src="https://www.googletagmanager.com/gtag/js?id=G-7VVK555MQK"><\/script><script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-7VVK555MQK');
<\/script><meta name="google-site-verification" content="8z4t6ut9IiaDmGuRfvBuJKlwbJ_tKuiUM8NXkHrAmVQ" \xA0><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="./favicon.svg"><meta name="generator"`, "><title>", "</title>", '</head> <body class="m-0 font-poppins  " data-astro-cid-sckkx6r4> ', " ", " ", " </body></html>"])), addAttribute(Astro2.generator, "content"), title, renderHead(), renderComponent($$result, "Navbar", $$Navbar, { "data-astro-cid-sckkx6r4": true }), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-sckkx6r4": true }));
